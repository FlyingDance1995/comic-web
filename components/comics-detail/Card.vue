        ...
        <div class="row g-0">
            <div class="col-md-3">
                <div class="m-3 text-center">
                    <img :src="data?.avatar"
                         class="img-fluid"
                         :alt="data?.name" style="width: 100%;" onerror="this.src='/no-image.png'">
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="card-body">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">
                            <span
                                class="btn btn-sm btn-primary px-3 radius-30">
                                Truyện Chữ
                            </span>
                        </dd>
                    ...
                    <div class="social_single_news clear overflow-hidden">
                        ...
                        <ul class="social_like_single clear mt-3 p-0">
                            <li class="fb_btn fb-like-tbn" style="list-style-type: none">
                                ...
                                <div class="fb-like fb_iframe_widget" data-href="/dong-chi"
